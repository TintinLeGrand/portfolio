...
export default function Projects() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <MainHeader>
        <MonoText className="text-lg md:text-2xl max-w-96">{ t('description') }</MonoText>
      </MainHeader>
      ...
      <div>
        ...
        <MonoText className="text-lg md:text-2xl max-w-96">{ t('texts.personal') }</MonoText>
      </div>
      <hr className="mx-4 border-black dark:border-white border rounded-full" />
      <div>
        <MonoTitle className="text-3xl md:text-5xl font-semibold">{ t('titles.scolarship') }</MonoTitle>
        <MonoText className="text-lg md:text-2xl max-w-96">{ t('texts.scolarship') }</MonoText>
      </div>
      <hr className="mx-4 border-black dark:border-white border rounded-full" />
      <div>
        <MonoTitle className="text-3xl md:text-5xl font-semibold">{ t('titles.professional') }</MonoTitle>
        <MonoText className="text-lg md:text-2xl max-w-96">{ t('texts.professional') }</MonoText>
      </div>
    </div>
  );
}
