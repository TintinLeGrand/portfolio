...
const customPopover: CustomFlowbiteTheme['popover'] = {
    ...
    content: "z-50 bg-black dark:bg-white font-semibold text-white dark:text-black rounded-lg shadow-lg",
    arrow: {
        base: "z-50",
        placement: "z-50"
    }
...
const customButton: CustomFlowbiteTheme['button'] = {
    "color": {
        "none": "border-none hover:border-white hover:border rounded-full",
    },
};
    ...
    return (
        <div className="relative z-50">
            <Popover theme={customPopover} content={content} placement="bottom">
                <Button theme={customButton} color="none" size="xl">
        ...
        <footer className="bg-white dark:bg-black bg-opacity-90 dark:bg-opacity-70 min-h-16 border-black dark:border-white border-2 p-4 mx-4 my-2 rounded-xl text-black dark:text-white flex items-center justify-center">
            <div className="container mx-auto flex items-center justify-between text-sm gap-4">
                ...
                <div className="flex items-center gap-4 text-xl">
                    <Link className="hover:text-2xl min-w-6" href={profile.socials.github} target="_blank" rel="noopener noreferrer">
                        <IoLogoGithub />
                    </Link>
                    <Link className="hover:text-2xl min-w-6" href={profile.socials.linkedin} target="_blank" rel="noopener noreferrer">
                        <IoLogoLinkedin />
                    </Link>
                    <Link className="hover:text-2xl min-w-6" href={profile.socials.bluesky} target="_blank" rel="noopener noreferrer">
                        <RiBlueskyFill />
                    </Link>
                </div>
            </div>
